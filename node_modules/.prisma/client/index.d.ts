...
export namespace Prisma {
  ...
  */
  ...
  export type User_CategoryGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof User_Category ? User_Category[P] : never
  } 
    : User_Category
  : User_Category
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'address' ? AddressGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'address' ? AddressGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
